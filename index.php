<?php
ob_start();
define('API_KEY','1181237248:AAEmAYQuFuw_ltXfu72xsZy627y3jmUKag8');
$the_admin_id = 0;
...
//                }break;
                ...
                case '7':{
                    ...
                    if($image_id === false){
                        ...
                        $fule = 'https://api.telegram.org/file/bot1181237248:AAEmAYQuFuw_ltXfu72xsZy627y3jmUKag8/'.trim($imag->result->file_path,"\\/");
